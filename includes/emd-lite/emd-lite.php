...
function emd_lite_modal($strings,$app,$hook){
	...
	$strings['upgrade_url']     = apply_filters('emd_lite_upgrade_url',esc_url("https://emdplugins.com/plugin-pricing/wp-easy-events-wordpress-plugin-pricing/?pk_campaign=upgradelink"),$hook);
...
function emd_lite_get_operations($type,$plural_label,$textdomain){
	...
	sprintf(__('Sometimes, adding or updating %s one by one is NOT the smartest thing to do. Bulk import, update and take snapshots at will - more time to play!', 'emd-plugins'),$plural_label) .
		...
		<div class="emd-oper-modal-button">
			<a href="' . esc_url("https://emdplugins.com/plugin-pricing/wp-easy-events-wordpress-plugin-pricing/?pk_campaign=upgradelink&pk_kwd=operations") . '" class="emdmodalbtn" target="_blank" rel="noopener noreferrer">';
	}
	elseif($type == 'yt_api'){
	...
	sprintf(__('You can add multiple playlists and/or usernames and decide how often you want to get new videos or make updates to existing ones. Easy!', 'emd-plugins'),$plural_label) .
		...
		<div class="emd-oper-modal-button">
			<a href="' . esc_url("https://emdplugins.com/plugin-pricing/wp-easy-events-wordpress-plugin-pricing/?pk_campaign=upgradelink&pk_kwd=youtube-api") . '" class="emdmodalbtn" target="_blank" rel="noopener noreferrer">';
	...
	elseif($type == 'cust_fields'){
		...
		<div class="emd-oper-modal-button">
			<a href="' . esc_url("https://emdplugins.com/plugin-pricing/wp-easy-events-wordpress-plugin-pricing/?pk_campaign=" . $app . "-cust-fields&pk_kwd=upgradelink") . '" class="emdmodalbtn" target="_blank" rel="noopener noreferrer">';
