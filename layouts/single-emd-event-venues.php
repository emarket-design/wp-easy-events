...
?>
<div id="single-emd-event-venues-<?php echo get_the_ID(); ?>" class="emd-container emd-event-venues-wrap single-wrap">
<?php $is_editable = 0; ?>
<div class="notfronteditable">
    <div class="section-wrapper">
        ...
        <div class="section-body" style="clear:both">
            <div class="emd-body-top">
                <div class="single-well well emd-event-venues">
                    <div class="row">
	...
	echo '12 well-right';
                            ...
                            <div class="srcontent emdbox">
                                ...
                                <div class="single-content segment-block ent-venue-fulladdress"><i aria-hidden="true" class="fa fa-map-marker fa-fw text-muted "></i> <?php echo esc_html(emd_mb_meta('emd_venue_fulladdress')); ?>
</div>
                                <?php
} ?><?php if (emd_is_item_visible('excerpt', 'wp_easy_events', 'attribute', 0)) { ?>
                                <div class="single-content segment-block excerpt"><?php echo $post->post_excerpt; ?></div>
                                <?php
} ?>
                            </div>
                        </div>
            ...
            <div class="emd-body-content">
                <div class="section-subbody" style="clear:both">
                    <?php if (emd_is_item_visible('ent_venue_map', 'wp_easy_events', 'attribute', 0)) { ?>
                    <div class="single-content segment-block ent-venue-map"><?php echo emd_get_attr_map('wp-easy-events', 'emd_venue_map', 'emd_blt_title', 'emd_venue_fulladdress'); ?>
</div>
                    <?php
            ...
            <div class="emd-body-bottom">
                <div class="relationwrap" id="relwrapper-54"> <?php if (emd_is_item_visible('entrelcon_event_venue', 'wp_easy_events', 'relation')) { ?>
<?php $post = get_post();
	$rel_filter = "";
...
?>
<div class="single-relpanel emd-wpe-event event-venue"><div class="accor-title"><?php _e('Events', 'wp-easy-events'); ?></div>  <?php
